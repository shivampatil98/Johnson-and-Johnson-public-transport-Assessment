...
- Google Maps Platform — Routes APIReal-world transit and driving travel times/distances, since building a full multi-transfer journey planner from raw GTFS data proved unreliable for realistic estimates (see Section 6)
